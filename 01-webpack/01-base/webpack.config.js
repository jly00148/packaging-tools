/*
 * @Author: jly
 * @Date: 2021-10-07 13:12:04
 * @LastEditTime: 2021-10-09 00:49:27
 * @FilePath: \packaging-tools\01-webpack\01-base\webpack.config.js
 * @文件已分为3文件：common dev prod
 */
...
module.exports = {
    ...
    plugins:[
        ...
        new MiniCssExtractPlugin({
            filename:"source/[name].[contenthash].css",//指定单独css所处的文件夹，
        }),
